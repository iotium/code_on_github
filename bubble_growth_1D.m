...
while running == 1;
    ...
    while error_OK == 0
        ...
        if adaptive == 1
            ...
            fprintf('max rel error is %4.4g, at index %d, y(i) = %4.4g\n', rel_err, ind_max_rel_err, y(ind_max_rel_err,n))
...
%         r_nuc/min(r_q(i,:))
    ...
    while ill_conditioned
        ...
        if n > 100
            ill_conditioned = 0;
                    disp('gave up trying to fix an ill-conditioned A matrix')
        end
